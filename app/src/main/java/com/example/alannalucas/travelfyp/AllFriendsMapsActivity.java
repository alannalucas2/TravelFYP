...
public class AllFriendsMapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewPlace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AllFriendsMapsActivity.this, SaveLocation.class);
    ...
    public void onMoreInfo(View view) {
        Toast.makeText(AllFriendsMapsActivity.this, "more info...", Toast.LENGTH_SHORT).show();
    }
